...
VPRN_SERVICE = "9998"
VPRN_BGP = "9999"
NEIGHBORS = ["172.16.1.3", "172.16.2.3"]
NEIGHBOR_POLICIES = {
    "172.16.1.3": {"master": "public_to_ISP_C1_Master", "backup": "public_to_ISP_C1_Backup"},
    "172.16.2.3": {"master": "public_to_ISP_C2_Master", "backup": "public_to_ISP_C2_Backup"},
}
...
def main():
    ...
    log("=" * 70)
    log("EHS SRRP BGP Policy Script v10 (SLAVE)")
    log("=" * 70)
    log("Trigger : " + ev_name)
    log("Text    : " + ev_text)

...
## 8.1 Verify ISA NAT group and members

Verify the ISA NAT group and its members.
...
## 8.2 Verify NAT sessions and policy operation

Verify NAT sessions and confirm that NAT operates according to the configured policies.

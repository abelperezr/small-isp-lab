...
## 5.1 Verify SAP QoS policies

Review the ingress and egress policies applied to SAPs:
...
## 5.2 Verify SLA profile association

Review the SLA profiles available for subscriber management:

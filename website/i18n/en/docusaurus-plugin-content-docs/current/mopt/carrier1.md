...
| **Management IP** | 10.99.1.252 |
| **SSH port** | 56610 |
| **ASN** | 65501 |
| **Loopback** | 10.255.1.1/32 |
| **Role** | Primary Carrier (LP 300 in BNGs) |

## Function in Topology

Carrier 1 is the **primary** transit provider. BNGs import their routes with Local-Preference 300 (highest priority). It maintains eBGP sessions with both BNGs (AS 65520) and advertises half-default routes (0.0.0.0/1 + 128.0.0.0/1 + ::/1 + 8000::/1) to them.

...
:::tip[Role]
This is the ISP's **primary** BNG. Under normal conditions it is SRRP Master for all three instances and announces the public prefixes with the least amount of AS-Path prepend to the carriers.

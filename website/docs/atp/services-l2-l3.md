---
sidebar_position: 3
sidebar_label: 4. Servicios L2/L3
---

# 4. Servicios L2/L3

## 4.1 Validación de utilización de SAPs y SDPs

Verifica los SDPs y SAPs asociados a cada servicio.

1. Usa el siguiente comando para revisar los servicios configurados en el BNG:
   `show service service-using`
2. Usa el siguiente comando para revisar los SAPs asociados a los servicios:
   `show service sap-using`
3. Usa el siguiente comando para revisar los SDPs configurados en los servicios:
...
## 4.2 Validación de VPRN

Verifica que los servicios VPRN estén operativos.
...
## 4.3 BGP dentro de la VPRN 9999

Usa los siguientes comandos para revisar el estado de los peers BGP y las rutas anunciadas y recibidas:

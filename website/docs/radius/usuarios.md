...
# Configuración de Usuarios RADIUS
...
| Atributo | Función |
|----------|---------|
| Alc-SLA-Prof-str | Perfil SLA (QoS) |
| Alc-Subsc-Prof-str | Perfil de suscriptor |
| Alc-Subsc-ID-Str | Identificador de suscriptor |
| Alc-MSAP-Interface | Group Interface destino |
| Alc-Delegated-IPv6-Pool | Pool para Prefix Delegation |
| Framed-Pool | Pool DHCPv4 |

...
|-----------|-------|
| **Hostname** | lig |
| **Imagen** | ghcr.io/srl-labs/network-multitool + Python3 |
| **IP de Gestión** | 10.99.1.12 |
| **Puerto SSH** | 56619 |
...
El LIG (Lawful Interception Gateway) recibe el tráfico interceptado desde los BNGs Nokia mediante el formato **ip-udp-shim** y lo presenta en un dashboard web (LEA Console) en tiempo real. Para más detalles sobre la arquitectura y funcionamiento, ver la sección [LEA Console](../lea-console/index.md).

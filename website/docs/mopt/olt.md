...
| **IP de Gestión** | 10.99.1.4 |
| **Puerto SSH** | 56614 |

## Función en la Topología

La OLT actúa como **switch de acceso** utilizando MAC-VRFs para bridging entre los BNGs y las ONTs. Cada servicio tiene su propio bridge domain con S-VLAN diferenciada, más un bridge domain para SRRP.

| MAC-VRF | S-VLAN | C-VLAN | Servicio | Interfaces |
|---------|--------|--------|----------|------------|
...
| bd-srrp | 4094 | - | SRRP Messages | e1/1.4094, e1/2.4094 |

...
| **IP de Gestión** | 10.99.1.253 |
| **Puerto SSH** | 56611 |
| **ASN** | 65502 |
| **Loopback** | 10.255.2.1/32 |
| **Rol** | Carrier Secundario (LP 150 en BNGs) |

## Función en la Topología

Carrier 2 es el proveedor de tránsito **secundario**. Los BNGs importan sus rutas con Local-Preference 150. Configuración idéntica a Carrier 1 pero con direccionamiento diferente.
